...
import {updateInfo,deleteMerchant,getPageList,addMerchants,LikeSearch} from '@/api/merchant'
...
const deleteRow = (index) => { 
  ...
  // then: 确定按钮点击事件
    .then(async() => {
      const res = await deleteMerchant(tableData.value[index].id)
...
const dialogButton =async () => { 
  ...
  if (dialogButtonText.value === '添加') {
    res = await addMerchants(dialogData)
  }
  ...
  <div class="common-layout">
    <el-container class="container">
      ...
      <el-header class="header">
        <el-row>
          <el-col :span="24"><span class="page-title">供应商列表</span></el-col>
        </el-row>
  ...
  <!-- 表单 -->
    ...
    >
      ...
      <el-form-item label="简介" prop="description">
        <el-input type="textarea" :rows="2" v-model="dialogData.description" />
      </el-form-item>
    </el-form>
    <!-- 表单按钮 -->
    <template #footer>
