...
public class GoodsController {
    ...
    public Result getGoods(
            @Parameter(description = "游标：最后一条商品的id", example = "0") Integer cursor,
            @Parameter(description = "返回的记录数", example = "10") Integer size){
    ...
    public Result likeGoods(
            ...
            @Parameter(description = "模糊匹配的零件名称", example = "螺丝")
            @RequestParam(required = false) String inputPart){
